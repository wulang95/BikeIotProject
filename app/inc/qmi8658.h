...
extern void qmi8658_get_chip_info(void);
...
extern void qmi8658_config_pedometer(unsigned short odr);
extern unsigned int qmi8658_read_pedometer(void);
extern void qmi8658_reset_pedometer(void);
#endif

#if defined(QMI8658_USE_FIFO)
extern void qmi8658_config_fifo(unsigned char watermark,enum qmi8658_FifoSize size,enum qmi8658_FifoMode mode,enum qmi8658_Interrupt int_map, uint8_t sensor);
