...
#define def_rtos_mutex_t    ql_queue_t
#define def_rtos_timer_t    ql_timer_t
#define def_rtos_mutex_t    ql_mutex_t


#define def_rtos_task_create(taskRef, tacksize, priority, taskStart)  ql_rtos_task_create((taskRef), (stackSize), (priority), #taskStart, (taskStart), NULL, 0);
